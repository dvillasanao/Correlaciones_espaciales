...
3. **structura de vecindad espacial basada en los $𝑘- vecinos$ más cercanos.**. Este método usa la distancia euclidiana en el espacio de coordenadas (latitud y longitud) para determinar los  $k$ vecinos más cercanos.    
