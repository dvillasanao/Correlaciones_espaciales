...
`X_kn4` se crea una lista de vecinos basada en la proximidad de coordenadas usando el método de los $k$ vecinos más cercanos (*k*-nearest neighbors, KNN) con $k = 4$.   
...
```
  ...
  | Regla del Torre (`X_nb_rook`)    | 5.75                           | 14,200           | ✅ Sí c|
  | KNN con \( k = 4 \) (`X_kn4`)    | 4                              | 9,876            | ❌ No |             
