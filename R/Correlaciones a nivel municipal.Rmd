---
title: "Análisis geoespacial a nivel municipal"
...
Recordemos La autocorrelación espacial positiva se presenta cuando valores altos [bajos] de la variable de estudio en una localización están asociados con valores altos [bajos] en las regiones vecinas.
...
- Un valor de $1$ indica ausencia de autocorrelación, es decir, que los valores de una zona no están relacionados con los valores de zonas cercanas.
- Los valores inferiores a $<1$ indican autocorrelación espacial positiva,
- Mientras que valores superiores a $>1$ indican autocorrelación espacial negativa (Griffith, 1987).    
